...
export const EVENTOS = [
  {
    ...
    popup: 'Feliz aniversário, Pietro! Que este dia seja tão lindo quanto você merece. A Emilly e eu te desejamos tudo de melhor 💙🎂',
    elements: ['🎂','🎈','🎊','✨','💙','🥳'],
  ...
  },
  {
    ...
    elements: ['🎃','👻','🦇','🕷️','🌙','⭐','🕸️'],
    bg: 'radial-gradient(ellipse at 50% 60%, #fff3e0 0%, #fbe9e7 55%, #fce4ec 100%)',
    accent: '#e65100',
  },
  {
